...
export type Team = {
  ...
  members?: { name: string; initials: string; role: string; skills?: string[]; teamsCount?: number; leaderCount?: number; projectsCount?: number; university?: string; department?: string; github?: string; linkedin?: string; }[];
};
