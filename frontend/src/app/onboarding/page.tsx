      ...
      <div className="mx-auto max-w-2xl rounded-[var(--radius-lg)] border border-slate-200 bg-[var(--surface)] p-6 shadow-sm dark:border-[var(--night-border-strong)] dark:bg-[var(--surface-raised)] dark:shadow-lg dark:shadow-black/35 sm:p-8">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-end">
          <button
            ...
            onClick={() => void onSubmit("/profil")}
            className="h-12 rounded-[var(--radius-md)] border border-[var(--flow-blue)] px-6 text-sm font-semibold text-[var(--flow-blue)] transition-opacity disabled:cursor-not-allowed disabled:opacity-40 hover:bg-[var(--flow-blue)]/5"
          >
            Profile gec
          </button>
          <button
